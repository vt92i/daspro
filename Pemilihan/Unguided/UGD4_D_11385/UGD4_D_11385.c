        ...
        switch (pilihan) {
            ...
            case 2:
                if (cekLog == 0) {
                    ...
                    printf("\n[1] Kamar Luxury\n");
                    printf("\tHarga Sewa/bulan        : Rp 1200000\n");
                    printf("\tKode kamar              : KL\n");
                    printf("\tFasilitas Lengkap       : Ya\n");

                    printf("\n[2] Kamar Business\n");
                    printf("\tHarga Sewa/bulan        : Rp 1000000\n");
                    printf("\tKode kamar              : BS\n");
                    printf("\tFasilitas Lengkap       : Ya\n");

                    printf("\n[3] Kamar Eksklusif\n");
                    printf("\tHarga Sewa/bulan        : Rp 850000\n");
                    printf("\tKode kamar              : EL\n");
                    printf("\tFasilitas Lengkap       : Ya\n");

                    printf("\n[4] Kamar Reguler\n");
                    printf("\tHarga Sewa/bulan        : Rp 500000\n");
                    printf("\tKode kamar              : RL\n");
                    printf("\tFasilitas Lengkap       : Tidak\n");

                    printf("\n[5] Kamar Ekonomi\n");
                    printf("\tHarga Sewa/bulan        : Rp 350000\n");
                    printf("\tKode kamar              : EM\n");
                    printf("\tFasilitas Lengkap       : Tidak\n");
                }
                break;
